...
static class XmlTools
{
    ...
    public static Boolean? ToBooleanNullable(this XElement element, string name) =>
    Boolean.TryParse((string?)element.Element(name), out var result) ? (Boolean?)result : null;
